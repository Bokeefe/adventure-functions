...
function ranDomer (theThing) {
	var choicePick = theThing[Math.floor(Math.random() * theThing.length)];
	return choicePick;
}

var chosenWeapon = ranDomer(weapons);
var chosenAction = ranDomer(actions);
var chosenMonster = ranDomer(monsters);
...
//I would like to know how to refresh the adventure with each click but this works.
